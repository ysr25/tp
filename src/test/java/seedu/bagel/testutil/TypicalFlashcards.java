...
public class TypicalFlashcards {
    ...
    public static final Flashcard ALICE = new FlashcardBuilder().withTitle("Alice Pauline")
            .withDescription("123, Jurong West Ave 6, #08-111").withSets("1")
